...
from read_data import getFilterPicLab
import numpy as np
import keras
...
checkpoint = ModelCheckpoint(filepath='file_model.h5',
                             monitor='val_loss',mode='auto' ,save_best_only='True')
callback_lists=[tensorboard,checkpoint]


IMAGE_SIZE = 32
raw_images, raw_labels = getFilterPicLab()
# print(raw_labels[1])
...
model = keras.Sequential([
    keras.layers.Conv2D(32, (3, 3), input_shape=(IMAGE_W, IMAGE_H, 1), strides=(1, 1), activation='relu', padding='SAME'),
...
sgd_optimizer = SGD(lr=learning_rate, decay=decay, momentum=0.8, nesterov=True)
